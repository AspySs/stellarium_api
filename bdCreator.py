...
def tables_check():
    ...
    c.execute("CREATE TABLE IF NOT EXISTS Users (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, mail TEXT UNIQUE, user_name TEXT, date_of_birth DATE, sex BOOLEAN, horoscope_sign INTEGER, google_id TEXT UNIQUE, facebook_id TEXT UNIQUE, password TEXT)")
    conn.commit()
    print(Fore.BLUE + "Успешно!" + " \n")
